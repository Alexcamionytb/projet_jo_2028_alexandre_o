...
<body>
    ...
    <nav>
        ...
        <a href="modification-gestion-athletes.php">Gestion Athletes</a>
        <a href="modification-gestion-resultats.php">Gestion Resultats</a>
        <a href="deconnexion.php">Deconnexion</a>
    </nav>

    <!-- Section principale pour afficher les résultats -->
    <h1 style="text-align:center;">Bienvenue Alexandre admin crif</h1>
